#!/usr/bin/env bash
echo "https://raw.githubusercontent.com/jhorowitz/mac-install-scripts/master/get-sudo.sh
https://raw.githubusercontent.com/jhorowitz/mac-install-scripts/master/homebrew.sh
